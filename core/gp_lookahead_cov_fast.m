function d_cov = gp_lookahead_cov_fast(gp,gp_opt,x_tr,y_tr,sigma_tr,x_s1,x_new,P,K_precomput)
...
cov_new = cov_new + diag(gp_noise_model_var(gp, x_tr, sigma_tr, x_new, gp_opt));
L_new = chol(cov_new,'lower');

cov_s1new = gp_pred_cov_fast(gp,x_tr,y_tr,x_s1,x_new,P,K_precomput);
cov_news1 = cov_s1new';
